...
(
    ...
    WAY               VARCHAR(255)           NOT NULL COMMENT '组卷方式(快码:KS_WAY,随机RANDOM,手动MANUAL)',
    TYPE              VARCHAR(255) COMMENT '试卷分类(快码:KS_TYPE)',
    STATUS            VARCHAR(2) COMMENT '发布状态(快码:TASK_IS,已发布:Y,未发布:N)',
    KS_TIME           FLOAT(6, 2) COMMENT '考试时间(分钟)',
    IS_SUBJECTIVE     VARCHAR(2) COMMENT '是否有主观题(快码:TASK_IS)',
    START_ACTIVE_TIME DATETIME COMMENT '有效时间',
    END_ACTIVE_TIME   DATETIME COMMENT '失效时间',
    VERSION_NUM       INT(11)  DEFAULT 0 COMMENT '版本号',
    CREATION_DATE     DATETIME DEFAULT NOW() NOT NULL COMMENT '创建时间',
...
(
    KI_ID             INT(11)                NOT NULL AUTO_INCREMENT COMMENT 'id',
    NAME              VARCHAR(255)           NOT NULL COMMENT '考试名称',
    EXAM_ID           INT(11)                NOT NULL COMMENT '试卷头表ID',
    KS_TIME           INT(11) COMMENT '考试时长(分)',
    START_ACTIVE_TIME DATETIME COMMENT '考试开始时间',
    END_ACTIVE_TIME   DATETIME COMMENT '考试结束时间',
    VERSION_NUM       INT(11)  DEFAULT 0 COMMENT '版本号',
    CREATION_DATE     DATETIME DEFAULT NOW() NOT NULL COMMENT '创建时间',
    CREATED_BY        INT(11)  DEFAULT -1    NOT NULL COMMENT '创建人',
    LAST_UPDATED_BY   INT(11)  DEFAULT -1    NOT NULL COMMENT '最后修改人',
...
(
    UI_ID             INT(11)                   NOT NULL AUTO_INCREMENT COMMENT 'ID',
    USER_ID           INT(11)                   NOT NULL COMMENT '用户ID',
    KI_ID             INT(11)                   NOT NULL COMMENT '考试信息表ID',
    ...
    LAST_UPDATE_LOGIN INT(11) COMMENT '最后登录人',
    PRIMARY KEY (UI_ID),
    FOREIGN KEY (KI_ID) REFERENCES KS_INFO (KI_ID),
...
-- 创建阅卷人员表
DROP TABLE IF EXISTS KS_MARK_INFO;
CREATE TABLE KS_MARK_INFO
(
    KMI_ID            INT(11)                NOT NULL AUTO_INCREMENT COMMENT 'ID',
    USER_ID           INT(11) COMMENT '阅卷人ID,只针对主观题',
    KI_ID             INT(11)                NOT NULL COMMENT '考试信息表ID',
    VERSION_NUM       INT(11)  DEFAULT 0 COMMENT '版本号',
    CREATION_DATE     DATETIME DEFAULT NOW() NOT NULL COMMENT '创建时间',
    CREATED_BY        INT(11)  DEFAULT -1    NOT NULL COMMENT '创建人',
...
(
    ...
    USER_INFO_ID      INT(11)                NOT NULL COMMENT '人员考试关联ID',
    USER_ID           INT(11)                NOT NULL COMMENT '用户ID',
    ...
    LAST_UPDATE_LOGIN INT(11) COMMENT '最后登录人',
    PRIMARY KEY (UA_ID),
    FOREIGN KEY (USER_INFO_ID) REFERENCES KS_USER_INFO (UI_ID),
    FOREIGN KEY (EXAM_DETAIL_ID) REFERENCES KS_EXAM_DETAIL (ED_ID),
    KEY IDX_USER_ID (USER_ID),
    KEY IDX_USER_EXAM_ID (USER_INFO_ID),
