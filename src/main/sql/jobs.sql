...
(
    ...
    PROPORTION        FLOAT(6, 2) COMMENT '指标比重',
...
(
    ...
    DURATION          DECIMAL(22, 2) COMMENT '正常时数(h)',
    DELAY             DECIMAL(22, 2) COMMENT '延期时数(h)',
...
-- 创建任务影响指标关联表
DROP TABLE IF EXISTS TASK_STANDARD_INDEX;
CREATE TABLE TASK_STANDARD_INDEX
(
    TSI_ID            INT(11)                NOT NULL AUTO_INCREMENT COMMENT 'ID',
    TS_ID             INT(11)                NOT NULL COMMENT '任务ID',
    INDEX_ID          INT(11)                NOT NULL COMMENT '影响指标表',
    VERSION_NUM       INT(11)  DEFAULT 0 COMMENT '版本号',
    CREATION_DATE     DATETIME DEFAULT NOW() NOT NULL COMMENT '创建时间',
    CREATED_BY        INT(11)  DEFAULT -1    NOT NULL COMMENT '创建人',
    LAST_UPDATED_BY   INT(11)  DEFAULT -1    NOT NULL COMMENT '最后修改人',
...
-- 创建任务知识库关联表
DROP TABLE IF EXISTS TASK_STANDARD_KNOWLEDGE;
CREATE TABLE TASK_STANDARD_KNOWLEDGE
(
...
(
    ...
    TS_ID             INT(11)                NOT NULL COMMENT '任务ID',
    PUSH_NODE         VARCHAR(255) COMMENT '推送节点(快码:TASK_PUSH_NODE),任务创建默认两个节点"任务触发推送","任务完成推送"',
...
(
    ...
    TASK_GROUP        VARCHAR(255) COMMENT '任务组(快码:TASK_GROUP),通过任务组和标准任务库关联',
    TASK_RATIO        FLOAT(6, 2) COMMENT '任务比重',
...
(
    ...
    ITEM                VARCHAR(255) COMMENT '评分项(快码:SCORE_ITEM)',
    TYPE                VARCHAR(255) COMMENT '证书类型(快码:TASK_GRADE_TYPE)',
    SCORE               FLOAT(6, 2) COMMENT '线下评分',
    DESCRIPTION         VARCHAR(750) COMMENT '评分描述',
    GRADE_TIME          DATETIME COMMENT '评分时间',
    ISSUED_TIME         DATETIME COMMENT '获证时间',
    START_ACTIVE_TIME   DATETIME COMMENT '生效时间',
    END_ACTIVE_TIME     DATETIME COMMENT '失效时间',
...
(
    ...
    PROPORTION        FLOAT(6, 2) COMMENT '维度占比',
    VERSION_NUM       INT(11)  DEFAULT 0 COMMENT '版本号',
    CREATION_DATE     DATETIME DEFAULT NOW() NOT NULL COMMENT '创建时间',
    CREATED_BY        INT(11)  DEFAULT -1    NOT NULL COMMENT '创建人',
    LAST_UPDATED_BY   INT(11)  DEFAULT -1    NOT NULL COMMENT '最后修改人',
...
(
    ...
    PROPORTION        FLOAT(6, 2) COMMENT '维度占比',
    IS_CLOSE_NODE     VARCHAR(2) COMMENT '完成节点(快码:TASK_IS)',
...
(
    ...
    PROPORTION_1      FLOAT(6, 2) COMMENT '一经比重',
    LEVEL_2           VARCHAR(255) COMMENT '二级维度',
    PROPORTION_2      FLOAT(6, 2) COMMENT '二级比重',
...
(
    ...
    SCORE             FLOAT(6, 2) COMMENT '任务得分',
    IS_APPEAL         VARCHAR(255) COMMENT '是否有申诉(快码:TASK_IS)',
    YEAR              VARCHAR(10) COMMENT '归属年度',
...
-- 创建任务组得分表(通过人员单任得分统计,通过USER_ID,PJC_ID,TS_ID三个维度汇总)
...
(
    ...
    NAME              VARCHAR(255) COMMENT '导入文本名称',
    VERSION_NUM       INT(11)  DEFAULT 0 COMMENT '版本号',
    CREATION_DATE     DATETIME DEFAULT NOW() NOT NULL COMMENT '创建时间',
    CREATED_BY        INT(11)  DEFAULT -1    NOT NULL COMMENT '创建人',
    LAST_UPDATED_BY   INT(11)  DEFAULT -1    NOT NULL COMMENT '最后修改人',
...
-- 创建KPI考核导入明细表
DROP TABLE IF EXISTS KPI_ASSESS_DETAIL;
CREATE TABLE KPI_ASSESS_DETAIL
(
    KAD_ID            INT(11)                NOT NULL AUTO_INCREMENT COMMENT 'ID',
    KA_ID             INT(11) COMMENT 'KPI考核导入表ID',
    USER_ID           INT(11) COMMENT '用户ID',
    USER_NAME         VARCHAR(255) COMMENT '人员',
    PJC_ID            INT(11) COMMENT '岗位ID',
    JOB_NAME          VARCHAR(255) COMMENT '岗位名称',
    INDEX_ITEM        VARCHAR(255) COMMENT '指标项',
    INDEX_RATIO       FLOAT(6, 2) COMMENT '指标占比',
    NORM_RATIO        FLOAT(6, 2) COMMENT '标准项',
    ACTUAL_RATIO      FLOAT(6, 2) COMMENT '实际项',
...
(
    ...
    TEMP_CODE         VARCHAR(255) comment '模板编码',
    JOB_NAME          VARCHAR(255) COMMENT '岗位名称',
...
-- 创建平价模板明细表
DROP TABLE IF EXISTS EVAL_TEMP_DETAIL;
CREATE TABLE EVAL_TEMP_DETAIL
(
    ETD_ID            INT(11)                NOT NULL AUTO_INCREMENT COMMENT 'ID',
    ET_ID             INT(11)                NOT NULL COMMENT '平价模板ID',
    NODE              VARCHAR(255) COMMENT '评价节点(快码:EVAL_NODE)',
    PROPORTION        FLOAT(6, 2) COMMENT '评价比重',
    SUPERIOR_ID       INT(11) COMMENT '上级分类ID,取模板库ID',
    SUPERIOR_NAME     INT(11) COMMENT '上级分类',
    PARITY_ID         INT(11) COMMENT '评价项ID,取模板库ID',
    PARITY_NAME       VARCHAR(255) COMMENT '评价项',
    DESCRIPTION       VARCHAR(750) COMMENT '描述',
    VERSION_NUM       INT(11)  DEFAULT 0 COMMENT '版本号',
    CREATION_DATE     DATETIME DEFAULT NOW() NOT NULL COMMENT '创建时间',
    CREATED_BY        INT(11)  DEFAULT -1    NOT NULL COMMENT '创建人',
...
(
    ...
    ERT_ID             INT(11)                NOT NULL COMMENT '发布评价ID',
    USER_ID           INT(11) COMMENT '用户ID',
    VERSION_NUM       INT(11)  DEFAULT 0 COMMENT '版本号',
    CREATION_DATE     DATETIME DEFAULT NOW() NOT NULL COMMENT '创建时间',
    CREATED_BY        INT(11)  DEFAULT -1    NOT NULL COMMENT '创建人',
    ...
    LAST_UPDATE_LOGIN INT(11) COMMENT '最后登录人',
    PRIMARY KEY (EN_ID),
    FOREIGN KEY (ERT_ID) REFERENCES EVAL_RELEASE_TEMP(ERT_ID),
    KEY IDX_ER_ID (ERT_ID),
    KEY IDX_USER_ID (USER_ID)
)
    ENGINE = InnoDB
    AUTO_INCREMENT = 55
...
-- 创建师父表
DROP TABLE IF EXISTS MD_MASTER;
CREATE TABLE MD_MASTER
(
    MM_ID             INT(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
    USER_ID           INT(11) NOT NULL COMMENT '师父id',
    CITY_ID           INT(11) NOT NULL COMMENT '师父城市ID',
...
-- 创建徒弟表
DROP TABLE IF EXISTS MD_DISCIPLE;
CREATE TABLE MD_DISCIPLE
(
    MD_ID           INT     NOT NULL AUTO_INCREMENT COMMENT 'id',
    USER_ID         INT(11) NOT NULL COMMENT '徒弟ID',
    CITY_ID         INT(11) NOT NULL COMMENT '徒弟城市ID',
...
(
    ...
    MM_ID             INT(11)                NOT NULL COMMENT '师父ID',
    MD_ID             INT(11)                NOT NULL COMMENT '徒弟ID',
    VERSION_NUM       INT(11)  DEFAULT 0 COMMENT '版本号',
    CREATION_DATE     DATETIME DEFAULT NOW() NOT NULL COMMENT '创建时间',
    CREATED_BY        INT(11)  DEFAULT -1    NOT NULL COMMENT '创建人',
    LAST_UPDATED_BY   INT(11)  DEFAULT -1    NOT NULL COMMENT '最后修改人',
